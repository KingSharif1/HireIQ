...
export function ProfileHome({
  ...
  return (
    <div className="flex flex-col min-h-dvh bg-white dark:bg-background">
      <header className="sticky top-0 z-20 border-b border-border bg-white dark:bg-background">
        <div className="flex items-center justify-between gap-3 px-3 md:px-4 py-2.5">
          <div className="min-w-0">
            <h1 className="text-base font-semibold text-foreground truncate">Profile</h1>
            <p className="text-xs text-muted-foreground truncate">
              Master resume — documents, career info, and section updates
            </p>
          </div>

 ...
 */
export function AiFlowLoader({ title, subtitle, stages, activeIndex, className }: AiFlowLoaderProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md">
        <motion.div
          aria-hidden
          className="pointer-events-none absolute -inset-6 rounded-[2rem] bg-gradient-to-br from-teal-500/15 via-transparent to-violet-500/10 blur-2xl"
        ...
        <div className="relative overflow-hidden rounded-2xl border border-border bg-card/90 p-6 backdrop-blur-sm">
          <div className="flex items-start gap-4">
            <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-teal-500/25 bg-teal-500/10">
              <motion.span
          ...
          <div className="mt-4 flex gap-1.5" aria-hidden>
            {[0, 1, 2].map(i => (
              <motion.span
                ...
                animate={reduceMotion ? undefined : { opacity: pulse === i ? 1 : 0.25, scale: pulse === i ? 1.2 : 1 }}

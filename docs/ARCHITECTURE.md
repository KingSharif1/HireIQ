...
- **Auto-apply:** extension path + hosted Playwright on Cloud Run — see [AUTO-APPLY.md](./AUTO-APPLY.md) · [PRICING.md](./PRICING.md). Queue table `apply_runs` (021); worker `services/apply-worker`.
